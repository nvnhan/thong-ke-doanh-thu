...
/* harmony import */ var _columns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./columns */ "./resources/js/pages/VeMayBay/DatVe/columns.js");
/* harmony import */ var _expandedRow__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./expandedRow */ "./resources/js/pages/VeMayBay/DatVe/expandedRow.js");
/* harmony import */ var _FormItem__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./FormItem */ "./resources/js/pages/VeMayBay/DatVe/FormItem.js");
/* harmony import */ var _otherButtons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./otherButtons */ "./resources/js/pages/VeMayBay/DatVe/otherButtons.js");
/* harmony import */ var _otherFilters__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./otherFilters */ "./resources/js/pages/VeMayBay/DatVe/otherFilters.js");
...
var List = function List(props) {
  var dinh_danh = props.location.dd;
  ...
  var retrieveData = function retrieveData() {
    ...
    Promise.all([promise1, promise2, promise3, promise4, promise5, promise6]).then(function (response) {
      if (isComponentMounted) if (response[0].data.success && response[1].data.success && response[2].data.success && response[3].data.success && response[4].data.success && response[5].data.success) {
        setState({
  ...
  var handleFormValue = function handleFormValue(props) {
    var record = Object(_tinhPhi__WEBPACK_IMPORTED_MODULE_12__["default"])(_objectSpread({
      state: state
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, dinh_danh !== undefined && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("div", {
    style: {
      padding: "16px 20px 0",
      backgroundColor: "#fff"
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("b", null, "D\u1EEF li\u1EC7u x\u1EED l\xFD \u0111\u01B0\u1EE3c:")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_ListForm__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ree: childRef,
    url: "dat-ve",
    filter: dinh_danh && {
      dd: dinh_danh
    ...
    otherFilter: _otherFilters__WEBPACK_IMPORTED_MODULE_11__["default"],
    filterInitialValue: {
      sb: "",
      xv: ""
    },
    ...
    modalWidth: "1200px",
    formTemplate: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_FormItem__WEBPACK_IMPORTED_MODULE_9__["default"], {
      danhMuc: state,
    ...
    otherButtons: Object(_otherButtons__WEBPACK_IMPORTED_MODULE_10__["default"])({
      showUpdates: showUpdates,
      history: props.history
    }),
    expandedRowRender: _expandedRow__WEBPACK_IMPORTED_MODULE_8__["default"],
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_UpdateLayout__WEBPACK_IMPORTED_MODULE_13__["default"], {
    danhMuc: state
  }))));
};

/* harmony default export */ __webpack_exports__["default"] = (react__WEBPACK_IMPORTED_MODULE_3___default.a.memo(Object(react_router_dom__WEBPACK_IMPORTED_MODULE_4__["withRouter"])(List)));
...
var veDienTuHTML = function veDienTuHTML(data, selectedRowKeys) {
  var u = localStorage.getItem("id");
  var ids = selectedRowKeys.join(",");
  var newWindow = window.open(window.location.origin + "/dat-ve/mat-ve/".concat(u, "/").concat(ids), "_blank", "noopener,noreferrer");
