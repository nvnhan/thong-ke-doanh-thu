...
Route::middleware('auth:api')->group(function () {
    ...
    // Ve May Bay
    Route::get('phi-hanh-ly/get-phi-hanh-ly', 'PhiHanhLyController@all');
    ...
    Route::get('thue-phi/get-thue-phi', 'ThuePhiController@all');
    ...
    // Thong Tin Chung
    Route::get('tai-khoan/get-tai-khoan', 'TaiKhoanController@all');
    ...
    // Route::get('nha-cung-cap/get-nha-cung-cap', 'NhaCungCapController@all');
    ...
    Route::get('khach-hang/get-khach-hang', 'KhachHangController@all');
    ...
    Route::get('ban-ra/xuat-hoa-don', 'BanRaController@xuathoadon');
    Route::resource('ban-ra', 'BanRaController')->only(['index', 'store', 'update', 'destroy']);
    Route::delete('hoan-doi/deletes', 'HoanDoiController@deletes');
    Route::resource('hoan-doi', 'HoanDoiController')->only(['index', 'store', 'update', 'destroy']);

    Route::delete('mua-vao/deletes', 'MuaVaoController@deletes');
    Route::get('mua-vao/xuat-hoa-don', 'MuaVaoController@xuathoadon');
