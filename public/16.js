...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _utils_downloadFile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../utils/downloadFile */ "./resources/js/utils/downloadFile.js");
/* harmony import */ var _utils_exportDatVe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../utils/exportDatVe */ "./resources/js/utils/exportDatVe.js");
...
var downloadApi = function downloadApi(url, selectedRowKeys, fileName) {
  ...
  antd__WEBPACK_IMPORTED_MODULE_1__["Modal"].info({
    ...
    content: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      showInfo: false,
      strokeColor: "#6dc3a6"
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("span", null, "\u0110ang t\u1EA1o b\xE1o c\xE1o..."))
  });
  axios.get(url, {
    params: {
    ...
    Object(_utils_downloadFile__WEBPACK_IMPORTED_MODULE_3__["default"])(url, fileName);
  })["catch"](function (error) {
    return console.log(error);
  }).then(function () {
...
var codeVe = function codeVe(data, selectedRowKeys) {
  axios.get("/api/dat-ve/code-ve", {
    ...
    if (response.data.success) {
      antd__WEBPACK_IMPORTED_MODULE_1__["Modal"].info({
        title: "Code vé",
        content: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_1__["Input"].TextArea, {
          rows: 12,
...
var otherButtons = function otherButtons(showUpdates) {
  return [{
    ...
    childs: [{
      ...
      icon: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_0__["FileTextOutlined"], null)
    }, {
      key: "vedientu",
      onClick: veDienTu,
